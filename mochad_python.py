...
print " [x] send_queue: ", send_exchange
print " [x] commands_queue: ", commands_queue
print " [x] commands_exchange: ", commands_exchange
...
def create_connection(host, credentials):
    ...
    print " [x] connected to 'mochad.sensorflare.com'"
    ...
    try:
        ...
        print ' [x] reconnecting in 5 seconds...'
        import time
